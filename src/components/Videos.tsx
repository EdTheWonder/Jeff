...
const Videos = () => {
  ...
  return (
    <section id="videos" className="py-20 bg-gradient-to-br from-neutral-950 via-neutral-900 to-neutral-950">
      <motion.div
        ref={ref}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="aspect-w-16 aspect-h-9">
            <iframe
              width="100%"
              height="500"
              src="https://www.youtube.com/embed/NnlODDf_hL0"
              title="Jeff Akoh YouTube Video"
              frameBorder="0"
